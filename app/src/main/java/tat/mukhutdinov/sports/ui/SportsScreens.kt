...
import tat.mukhutdinov.sports.R
...
fun SportsListAndDetails(
    ...
    Row(modifier = modifier) {
        ...
        SportsDetail(
            selectedSport = state.currentSport,
            contentPadding = contentPadding,
...
@Preview(showSystemUi = true, device = "spec:id=reference_tablet,shape=Normal,width=1280,height=800,unit=dp,dpi=240")
@Composable
fun SportsListAndDetailsPreview() {
    SportsTheme {
        SportsListAndDetails(
            state = SportsUiState(LocalSportsDataProvider.getSportsData()),
